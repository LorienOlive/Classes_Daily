...
// The constructor should have the following properties: model, doors, color,
// enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof.
...
// It should extend from 'Factory'.
// The constructor should have the following properties: model, color, enginesize,
// hitch, bed, navigation. The values should be specified when creating an instance of Truck.
...
console.log(mazda3.massBuild("35,000", [" Red", " Touring", " Mazda3"]))
...
console.log(mazda3.customerBuild(" Yellow", mazda3.trim, mazda3.model, ["weather package", " satellite radio", " rear spoiler" ] ))
...
let miataRF = new Sport(" Miata-RF", " Grand Touring", "manual", "hard top", " red", "leather", "premium", "premium")
                        // model, trim, transmission, top, color, seatstrim, audio, wheelstrim, moonroof, enginetype, convertible, doors
...
console.log(miataRF.massBuild("15000", [miataRF.color, miataRF.trim, miataRF.model]))
...
console.log(miataRF.customerBuild(" Black", miataRF.trim, miataRF.model, [" hid headlights", " sports suspension", " leather steering wheel", " heated seats", " adaptive cruise control"]))
...
console.log(trailBlazer.customerBuild("Red", trailBlazer.trim, trailBlazer.model, ["seat warmers", " tinted windows", " fog lamps"]))
